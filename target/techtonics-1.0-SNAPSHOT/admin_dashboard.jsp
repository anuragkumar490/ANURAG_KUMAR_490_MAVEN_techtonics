...
<script type="text/javascript">
	...
	function fillValues(talkId) {
		...
		alert("Title:" + var_title);
		// document.getElementById("title").value = var_title;
		document.forms['edt_form']['title'].value = var_title;
	...
	var y = function(id) {
		...
		xmlRequest.onreadystatechange = function() {
			if (this.readyState == 4 && this.status == 200) {
				...
				if (this.responseText == "No user registered yet!") {
					document.getElementById("model_foot").innerHTML = "Total: 0";
				} 
				else {
	...
	<div id="myModal2" class="modal">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form id='edt_form' action="update_talk">
